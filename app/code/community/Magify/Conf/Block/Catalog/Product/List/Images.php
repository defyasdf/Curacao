...
* @package Magify_Conf
*/
class Magify_Conf_Block_Catalog_Product_List_Images extends Mage_Core_Block_Template
{
    protected $product;
    protected $block;
    protected $html;
    ...
    {
        parent::__construct();
        $this->setTemplate('mconf/options.phtml');
        $this->block = Mage::app()->getLayout()->createBlock('mconf/catalog_product_view_type_configurable', 'mconf.catalog_product_view_type_configurable');
    }
    ...
    public function show($productId) {
        ...
        $blockOptions = Mage::app()->getLayout()->createBlock('catalog/product_view_type_configurable', 'catalog.product_view_type_configurable',array('template'=>"mconf/configurable.phtml"));
