<?php
class Magify_OneStepCheckout_Model_Observers_PresetDefaults extends Mage_Core_Model_Abstract {
     ...
     * @return Magify_OneStepCheckout_Model_Observers_PresetDefaults
     */
