 ...
 */
class Magify_BannerManager_Block_Adminhtml_Bannermanager_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('magifybannermanagergrid');
    ...
    {
        $collection = Mage::getModel('magify_bannermanager/banner')->getCollection()->addStats();
    ...
    protected function _prepareColumns()
    {
        ...
        {
            $this->addColumn('banner_store', array(
        ...
        $this->addColumn('banner_click_count', array(
