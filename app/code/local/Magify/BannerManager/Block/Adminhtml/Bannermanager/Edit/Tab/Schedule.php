 ...
 */
class Magify_BannerManager_Block_Adminhtml_Bannermanager_Edit_Tab_Schedule extends Mage_Adminhtml_Block_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
    	return Mage::registry('magify_bannermanager_current_banner')->getData('banner_schedule');
    }
    
    public function elementId()
    {
    	return 'banner_schedule';
    }
