 ...
 */
class Magify_BannerManager_Block_Adminhtml_Bannermanager_Edit_Tab_History extends Mage_Adminhtml_Block_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        return Mage::helper('magify_bannermanager')->__('History Log');
    }
