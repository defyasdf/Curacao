 ...
 */
class Magify_BannerManager_Block_Adminhtml_Bannermanager_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
	 ...
	 {
        return $this->getUrl('*/magifybannermanager/save');
	 }
}