<?php
class Magify_BannerManager_Block_Adminhtml_Bannermanager_Groups_Edit_Tab_Locations_Custom_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    {
        parent::__construct();
        $this->setId('magify_bannermanager_groups_locations_custom_grid');
        $this->setDefaultSort('key');
        $this->setUseAjax(true);
        if($this->_getBannerGroup()->getData('locations/custom'))
        {
    ...
    {
    	$customs = $this->_getBannerGroup()->getData('locations/custom');
