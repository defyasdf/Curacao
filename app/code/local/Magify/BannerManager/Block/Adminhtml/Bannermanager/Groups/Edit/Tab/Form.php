 ...
 */
class Magify_BannerManager_Block_Adminhtml_Bannermanager_Groups_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
	{
		...
		$fieldset->addField('sort', 'text', array(
			'name'      	=> 'sort',
			'label'     	=> Mage::helper('magify_bannermanager')->__('Sort Priority'),
			'title'     	=> Mage::helper('magify_bannermanager')->__('Sort Priority'),
			'required'  	=> false,
            'disabled'  	=> $isElementDisabled,
			'note'			=> 'Larger first.',
		));
		
        $fieldset->addField('page_position', 'select', array(
            ...
            'disabled'  => ($isElementDisabled || $model->getPagePosition()),
        	'note'		=> ($model->getPagePosition()) ? 'If you want to change the position you will need recreate the group.' : 'Once set can not be updated.',
        ));
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            $fieldset->addField('group_store', 'multiselect', array(
                'name'      => 'group_store[]',
            ...
            $fieldset->addField('group_store', 'hidden', array(
                'name'      => 'group_store[]',
		...
		Mage::dispatchEvent('magify_adminhtml_bannermanager_group_edit_tab_form_prepare_form', array('form' => $form));
