 ...
 */
class Magify_BannerManager_Block_Adminhtml_Bannermanager_Edit_Tab_Locations extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _prepareLayout()
    {
    	$this->addTab('banner_locations_categories', array(
        	...
        	'content'   => $this->_translateHtml($this->getLayout()
            	->createBlock('magify_bannermanager/adminhtml_bannermanager_edit_tab_locations_categories')->toHtml()),
		));
