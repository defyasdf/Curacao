...
class Curacao_Credit_OnepageController extends Mage_Checkout_OnepageController
{
    ...
    public function saveCreditAction()
    {
	    ...
	    if($_curacao_credit_customerDiscount != "" and Mage::getSingleton('customer/session')->getCustomerId() != "")
            	$this->createCRule($_curacao_credit_customerDiscount,'30');
   ...
   public function createCRule($amt,$amt1){
  ...
  // $credit = $amt[0];
   ...
   $ccode = Mage::helper('core')->getRandomString(16);
    $data = array(
	    'product_ids' => null,
	    'name' => sprintf('AUTO_GENERATION CUSTOMER_%s - Curacao Credit', Mage::getSingleton('customer/session')->getCustomerId()),
	    'description' => 'Curacao Credit',
	    'is_active' => 1,
	    'website_ids' => array(1),
