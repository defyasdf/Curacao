...
//	print_r($_REQUEST);
	...
	if(mysql_query($query)){
		...
		/* $sql = 'update catalog_category_product set position = "'.$i.'" where category_id = "'.$_REQUEST['catId'].'" and product_id = "'.$_REQUEST['cat'][1][$i].'"';
			//echo '<br>';
			if(mysql_query($sql)){
				$msg = '1';
			}else{
			...
			//echo $msg."<br>";*/
			 ...
			 $pr[$_REQUEST['cat'][1][$i]] = $i;	
		}
		
		$category = new Mage_Catalog_Model_Category();
		$category->load($_REQUEST['catId']); //My cat id is 10
