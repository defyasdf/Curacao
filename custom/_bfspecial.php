...
// subject
$subject = 'Black Friday Cron At 12 AM';
// message
$message = '
<html>
<head>
  <title>Black Friday Cron At 12 AM</title>
	...
	<tbody>
									...
									<tbody>
										<tr>
											<td align="left" width="500">
                                                <span style="font-family: Arial, sans-serif; font-size: 16px; color: #444444; font-weight: bold;">Black Friday Cron At 12 AM</span>
											<td align="right">
		...
		<tr>
			<td colspan="2" style="font-family: Arial, sans-serif; font-size: 12px; padding: 20px 20px 0 20px; border-top: 1px solid #CCCCCC; border-left: 1px solid #CCCCCC; border-right: 1px solid #CCCCCC;">
				...
				<p style="font-size:12px; line-height:16px; margin:0 0 16px 0;">Your Cron at 12 AM friday ran successfully please check and make sure it worked:  <b></b></p>
