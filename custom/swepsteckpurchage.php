...
while($row1 = mysql_fetch_array($re)){
	...
	$data[] = array("Customer_Name"=>$row1['firstname'].' '.$row1['lastname'],"Customer_email"=>$row1['email'],"No_of_order"=>$num,"Total_purchase"=>$total,"Curacao_credit"=>$curacao_credit,"Order_Status"=>$status);
