...
class Login {
    ...
    private function loginWithPostData() {
            ...
            $checklogin = $this->connection->query("SELECT user_name, user_email, user_password_hash FROM customusers WHERE user_name = '".$this->user_name."';");
    ...
    private function registerNewUser() {
        ...
        if (empty($_POST['user_name'])) {
            ...
            $this->errors[] = "Password and password repeat are not the same";            
                ...
                $query_check_user_name = $this->connection->query("SELECT * FROM customusers WHERE user_name = '".$this->user_name."'");
                ...
                if($query_check_user_name->num_rows == 1) {
                    ...
                    $query_new_user_insert = $this->connection->query("INSERT INTO customusers (user_name, user_password_hash, user_email) VALUES('".$this->user_name."', '".$this->user_password_hash."', '".$this->user_email."')");
