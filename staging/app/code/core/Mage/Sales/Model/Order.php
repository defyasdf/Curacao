...
class Mage_Sales_Model_Order extends Mage_Sales_Model_Abstract
{
    ...
    public function cancel()
    {
        if ($this->canCancel()) {
			...
			//echo $this->getId();
			$estimate = $this->cancelEstimate($this->getEstimatenumber());
           	$this->addStatusToHistory($this->getStatus(), $estimate, false);
			$this->save();
	...
	public function cancelEstimate($inv){
		...
		$creditDP = $proxy->CancelSupplyInvoice(array('InvNo'=>$inv));
		$crdp = $creditDP->CancelSupplyInvoiceResult;
