<?php
class Magify_BannerManager_Block_Adminhtml_Bannermanager_Edit_Tab_Locations_Pages_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    {
        parent::__construct();
        $this->setId('magify_bannermanager_locations_pages_grid');
        $this->setDefaultSort('page_id');
        $this->setUseAjax(true);
        if ($this->_getBanner()->getData('locations/pages')) {
    ...
    {
        return $this->_getBanner()->getData('locations/pages');
    }    
