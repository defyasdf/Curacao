 ...
 */
class Magify_BannerManager_Block_Adminhtml_Bannermanager_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    {
        parent::__construct();
        $this->setId('magify_bannermanager_product_grid');
    ...
    {
        $products = array();
        foreach ($this->_getBanner()->getBannerAssociatedEntities(Magify_BannerManager_Model_Banner::PRODUCT_ENTITY) as $entity_id => $position) {
            $products[$entity_id] = array('position' => $position);
        }
        return $products;
    }
}
