 ...
 */
class Magify_BannerManager_Model_Resource_Custom_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{		
    /**
    ...
    {
        $this->_init('magify_bannermanager/custom');
