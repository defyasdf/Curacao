...
class Magify_SearchIndex_Model_Indexer_Maction extends Magify_SearchIndex_Model_Indexer_Abstract
{
    public function getIndexModel()
    {
        return Mage::getSingleton('searchindex/index_maction');
    }
    ...
    protected function _getSearchableEnteties($storeId, $entitIds = null, $lastEntityId = 0, $limit = 100)
    {
        ...
        if ($entitIds) {
            $collection->addFieldToFilter('action_id', array('in' => $entitIds));
        }
