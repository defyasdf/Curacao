<?php 
	...
	$sql = "SELECT * FROM `sales_flat_quote` WHERE `items_qty` > 0 AND `customer_email` != '' AND `customer_firstname` != '' and created_at < '".date('Y-m-d')."' and retargeted = 0 group by customer_email";
