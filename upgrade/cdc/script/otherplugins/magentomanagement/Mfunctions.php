...
for($i=0;$i< $catsize;$i++)
{
echo "INSERT INTO `relatedproducts_magento` (`id`, `catmagid`, `magproductid`, `productname`, `productsku`, `productupc`, `productPrice`, `productStatus`, `dateandtime`) VALUES (NULL, $product_category[$i], '$productId', '$prduct_name', '$sku', '$prduct_upc', '$price', '1', CURRENT_TIMESTAMP)";
mysql_query("INSERT INTO `relatedproducts_magento` (`id`, `catmagid`, `magproductid`, `productname`, `productsku`, `productupc`, `productPrice`, `productStatus`, `dateandtime`) VALUES (NULL, $product_category[$i], '$productId', '$prduct_name', '$sku', '$prduct_upc', '$price', '1', CURRENT_TIMESTAMP)");
}
}
