...
function getProperty($var){
	...
	if($var == 'shipaccount') Return '344057532';
	if($var == 'billaccount') Return '344057532';
	if($var == 'dutyaccount') Return 'XXX';
	if($var == 'accounttovalidate') Return 'XXX';
	if($var == 'meter') Return '104632842';
	if($var == 'key') Return 'ZYRhEkWPUfttQRol';
	if($var == 'password') Return 'iP9yznVaIyPIv9QcowwbZ8eS4';
	...
	if($var == 'account') Return '344057532';
