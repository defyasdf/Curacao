...
<input type="hidden" id="appId" value="0" name="appid" />
    <div style=" line-height:2">
    	<div style="width:330px; float:left; margin-right:20px;">
            ...
            <div>
                <label>Ciudad<span id="require">*</span></label><br />

                <input type="text" name="city" required="required" class="required" style="width:105px"  />
            </div>
            <div>
                <label>Estado<span id="require">*</span></label><br />
	...
	<option value="WY">Wyoming</option>
            ...
            <div>
                <label>C&oacute;digo Postal<span id="require">*</span></label><br />
        ...
        <div style="width:330px; float:left;">
       		<div>
                ...
                <label>Tiempo Viviendo en la Actual Direcci&oacute;n<span id="require">*</span></label><br />
            ...
            <div id="phones">
                <label>Tel&eacute;fono de Casa<span id="require">*</span></label> <br />
            ...
            <div>
                <label>Fecha de Nacimiento<span id="require">*</span></label><br />
           ...
           <div id="ssn">
                <label>Seguro Social # <span id="require">*</span></label> <br />
            ...
            <div>
                <label>N&uacute;mero de ID<span id="require">*</span></label><br />

                <input type="text" name="id_number" required="required" class="required" id="idNum"  />
            </div>
            <div>
                <label>Tipo de ID<span id="require">*</span></label><br />
            ...
            <div>
                <label>ID Expiration Date<span id="require">*</span></label><br />
            ...
            <div>
                <label>Estado del ID<span id="require">*</span></label><br />
