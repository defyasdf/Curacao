                            ...
                            <table class="tablesorter" cellspacing="0"> 
                                    <thead> 
                                       ...
                                       <tbody> 
                                        ...
                                        <td>Product Name</td>
										<?php for($i=0;$i<$num;$i++){?>
										<td valign="top"><input type="radio" required name="pname" id="pnm" onclick="return placevalue('pnm','pname')" value="<?php echo $content['pname'][$i]?>"> <?php echo $content['pname'][$i]?></td>         <?php }?>                              	
                                        <td valign="top"><input type="radio" required name="pname" id="pnm1" onclick="return placevalue('pnm1','pname')" value="<?php echo htmlspecialchars($content['etilizeName'],ENT_QUOTES)?>"> <?php echo $content['etilizeName']?></td>                                       	 
                    ...
                    <div id="step2" class="steps">
                            ...
                            <table class="tablesorter" cellspacing="0"> 
                                   ...
                                   <tbody> 
										...
										<?php for($i=0;$i<$num;$i++){?>
										<td valign="top"><input type="radio" required name="pdesc"  onclick="return placehtml('dsc','pdesc')"><div id="dsc"><?php echo htmlspecialchars($content['pdesc'][$i],ENT_QUOTES)?></div></td>              <?php }?>                         	
										<td valign="top"><input type="radio" required name="pdesc" onclick="return placehtml('dsc1','pdesc')"><div id="dsc1"> <?php echo ($content['etilizeDesc'])?></div></td>											
                                    ...
                                    <thead> 
                                       ...
                                       <tbody> 
                                        ...
                                        <td valign="top">Product Features</td>
										 <?php for($i=0;$i<$num;$i++){?>
										<td valign="top"><input type="radio" required name="pfeature" value="<?php echo $content['pfeature'][0]?>"  onclick="return placehtml('ftr','features')"> <div id="ftr"><?php echo htmlspecialchars_decode($content['pfeature'][$i],ENT_QUOTES)?></div></td>                                     
                                        <?php }?>
                                        <td valign="top"><input type="radio" required name="pfeature"  onclick="return placehtml('ftr1','features')" value="<?php echo $content['pfeature'][0]?>"> <div id="ftr1"><?php echo ($content['etilizeFeature'])?></div></td>                                       	
                                    ...
                                    <thead> 
                                       ...
                                       <tbody> 
                                        ...
                                        <td valign="top">Product Specifications</td>
										 <?php for($i=0;$i<$num;$i++){?>
										<td valign="top"><input type="radio" required name="pspecs" onclick="return placehtml('spc','specs')" value="<?php echo $content['pspecs'][0]?>"><div id="spc">  <?php echo htmlspecialchars_decode($content['pspecs'][$i])?></div></td>   
                                        <?php }?>                                    	
										<td valign="top"><input type="radio" required name="pspecs" onclick="return placehtml('spc1','specs')" value="<?php echo $content['pspecs'][0]?>"> <div id="spc1">
                                       <table>
                                       	<?php
