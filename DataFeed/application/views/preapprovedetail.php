...
<article class="module width_full">
			<header><h3>Overall Pre-approved KPI</h3></header>
		<article class="module width_full">
        	<div class="tab_container">
            	<ul>
                	<li>
                    	<a href="http://www.icuracao.com/DataFeed/index.php/onlinepreapprove?sdate=<?php echo $_REQUEST['sdate']?>&edate=<?php echo $_REQUEST['edate']?>">Ecomm Pre-Approve KPI</a>
                    </li>
                    <li>
                    	<a href="http://www.icuracao.com/DataFeed/index.php/applepreapprove?sdate=<?php echo $_REQUEST['sdate']?>&edate=<?php echo $_REQUEST['edate']?>">Apple Pre-Approve KPI</a>
                    </li>
                </ul>
            </div>
        </article>			
