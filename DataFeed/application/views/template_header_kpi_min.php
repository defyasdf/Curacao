...
<?php 
	...
	foreach($content as $key=>$val){?>
      ...
      google.setOnLoadCallback(drawChart<?php echo $num?>);
	  google.setOnLoadCallback(drawChart1<?php echo $num?>);
      google.setOnLoadCallback(drawChart2<?php echo $num?>);
      google.setOnLoadCallback(drawChart3<?php echo $num?>);
      // Callback that creates and populates a data table,
      // instantiates the pie chart, passes in the data and
      // draws it.
      function drawChart<?php echo $num?>() {
        ...
        // Set chart options
        var options = {'title':'Break Down for <?php echo $val['count']?> <?php echo $key?> campaign Visit',
                       'width':600,
                       'height':500};

        // Instantiate and draw our chart, passing in some options.
        var chart = new google.visualization.PieChart(document.getElementById('chart_div<?php echo $num?>'));
        chart.draw(data, options);
      }
	   function drawChart1<?php echo $num?>() {
        ...
        // Instantiate and draw our chart, passing in some options.
        var chart = new google.visualization.PieChart(document.getElementById('chart_div1<?php echo $num?>'));
        chart.draw(data, options);
      }
	
	
   function drawChart2<?php echo $num?>() {
        ...
        // Instantiate and draw our chart, passing in some options.
        var chart = new google.visualization.PieChart(document.getElementById('chart_div2<?php echo $num?>'));
        chart.draw(data, options);
      }



	 function drawChart3<?php echo $num?>() {
        ...
        // Instantiate and draw our chart, passing in some options.
        var chart = new google.visualization.PieChart(document.getElementById('chart_div3<?php echo $num?>'));
        chart.draw(data, options);
      }
	<?php 
	$num++;
